...
\vspace*{-80mm}
\chapter{Isokinetic Sine Wave Advection} \label{chapter4:verification_1}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.45\textwidth]{images/Temporal_Study/Order_Of_Accuracy_Summary}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.45\textwidth]{images/Spatial_Study/Order_Of_Accuracy_Summary}

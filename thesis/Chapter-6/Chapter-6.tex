...
\section{Modified Equation Analysis}
    ...
    When the energy equation undergoes a similar modified eqaution analysis, the
...
this analysis, a significant amount of information was added to the VTK output

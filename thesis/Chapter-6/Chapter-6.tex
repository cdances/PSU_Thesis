...
the CFL number below 0.500. To keep the computational resources needed
...
Taking the derivative of the analytical solutuion, the exact numerical error can
...
was scaled by a factor of $\frac{x}{L}$ to account for numerical propogation.
...
expected error, and the calculated error. However, this is small enought that it
